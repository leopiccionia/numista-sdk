...
• `Optional` **edge**: [`TypeSideUpdate`](TypeSideUpdate.md)
...
• `Optional` **obverse**: [`TypeSideUpdate`](TypeSideUpdate.md)
...
• `Optional` **reverse**: [`TypeSideUpdate`](TypeSideUpdate.md)
...
• `Optional` **watermark**: [`TypeSideUpdate`](TypeSideUpdate.md)
